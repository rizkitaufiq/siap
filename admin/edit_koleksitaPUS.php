...
if($_POST['rowid']){
    ...
    <form method="post" action="edittaPUS.php">
        ...
        <?php echo "<input type='text' name='dosbimTA' class='form-control1' required='' value='".$lihat['dosbimTA']."'>"?>
        <br><br>
         <label>Dosen Pembimbing II</label>
        <?php echo "<input type='text' name='dosbimTA1' class='form-control1' required='' value='".$lihat['dosbimTA1']."'>"?>
        <br><br>
        <label>Subjek</label>
