...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div class="graphs">
     	<div class="col_3">
     		<h1 style="margin-left: 37%">ARSIP TUGAS AKHIR</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="search pull-right">
                    <form action="TApus.php" method="GET">
      ...
      <table class="table">
       ...
       <?php
        $page = isset($_GET['page']) ? intval($_GET['page']) : 1; 
                ...
                echo "<td><button name='edit' data-id='".$hasil['id_tmpkoleksita']."' data-toggle='modal' data-target='#edit' class='btn-primary btn fa fa-pencil'></button></td>";
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                 ...
                 <h1 style="text-align: center;">Isi Arsip TA</h1>
                </div>
            <div class="modal-body">
                <form method="post" id="insert_form" action="tambahtaPUS.php" enctype="multipart/form-data">
                    ...
                    <input type="text" name="dosbimTA1" class="form-control1">
                    <br><br>
