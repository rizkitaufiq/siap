...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div class="graphs">
     	<div class="col_3">
     		<h1 style="margin-left: 34%">ARSIP KERJA PRAKTEK</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="search pull-right">
                    <form action="koleksiKP.php" method="GET">
        ...
        $page = isset($_GET['page']) ? intval($_GET['page']) : 1; 
                $adjacents = isset($_GET['adjacents']) ? intval($_GET['adjacents']) : 3; 
                    ...
                    if(isset($_REQUEST['cari']) && $_REQUEST['cari']<>""){
                        ...
                        $lihat = mysqli_query($con, "SELECT * FROM koleksikp WHERE judul LIKE '%$cari%' OR penulis LIKE '%$cari%' OR jurusan LIKE '%$cari%' OR dosbimKP LIKE '%$cari%' ORDER BY judul ASC"); 
                ...
                echo "<td><button name='lihat' data-id='".$hasil['id_koleksiKP']."' data-toggle='modal' data-target='#lihat' class='btn-succes btn fa fa-eye' ></button></td>";
                echo "<td><button name='edit' data-id='".$hasil['id_koleksiKP']."' data-toggle='modal' data-target='#edit' class='btn-primary btn fa fa-pencil'></button></td>";
                echo "<td><button name='hapus' data-id='".$hasil['id_koleksiKP']."' data-toggle='modal' data-target='#hapus' class='btn-danger btn fa fa-trash-o'></button></td>";
            echo "</tr>";
            $i++;
            $count++;
            }
    ...
    <div class="modal fade" id="tambahmodal">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form method="post" id="insert_form" action="tambahKP.php" enctype="multipart/form-data">
