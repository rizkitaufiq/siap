...
<div id="wrapper">
    ...
    <div class="table-responsive">
        ...
        $query  = mysqli_query($con,"SELECT * FROM log JOIN user ON log.id_user=user.id JOIN koleksiebook ON log.id_koleksi=koleksiebook.id_koleksiEBOOK ORDER BY waktu DESC");
        $no      = 1;
