        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="search pull-right">
                    <form action="koleksiEBOOK.php" method="GET">
        ...
        $page = isset($_GET['page']) ? intval($_GET['page']) : 1; 
                $adjacents = isset($_GET['adjacents']) ? intval($_GET['adjacents']) : 3; 
                    ...
                    if(isset($_REQUEST['cari']) && $_REQUEST['cari']<>""){
                        ...
                        $lihat = mysqli_query($con, "SELECT * FROM koleksiebook WHERE judul LIKE '%$cari%' OR penulis LIKE '%$cari%' OR jurusan LIKE '%$cari%' ORDER BY judul ASC"); 
                        $reload = $_SERVER['PHP_SELF'] . "?cari=".$cari."&amp;adjacents=".$adjacents; 
                    } else{
                        $lihat = mysqli_query($con, "SELECT * FROM koleksiebook ORDER BY judul ASC"); 
     		...
     		echo "<tr>";
                ...
                echo "<td><button name='lihat' data-id='".$hasil['id_koleksiEBOOK']."' data-toggle='modal' data-target='#lihat' class='btn-succes btn fa fa-eye' ></button></td>";
                echo "<td><button name='edit' data-id='".$hasil['id_koleksiEBOOK']."' data-toggle='modal' data-target='#edit' class='btn-primary btn fa fa-pencil'></button></td>";
                echo "<td><button name='hapus' data-id='".$hasil['id_koleksiEBOOK']."' data-toggle='modal' data-target='#hapus' class='btn-danger btn fa fa-trash-o'></button></td>";
            echo "</tr>";
            $i++;
            $count++;
            }
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                 ...
                 <h1 style="text-align: center;">Isi E-Book</h1>
                </div>
            <div class="modal-body">
                <form method="post" id="insert_form" action="tambahEBOOK.php" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="lihat">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h3 style="text-align: center;" class="modal-title">Lihat E-BOOK</h4>
                </div>
            <div class="modal-body">
    ...
    <div class="modal fade" id="edit">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h3 style="text-align: center;" class="modal-title">Edit E-BOOK</h4>
                </div>
            <div class="modal-body">
                <div class="fetched-data"></div>
            </div>
