...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="graphs">
            <div class="col_3">
                <div class="container">
    <h2 style="margin-left: 37%">KERJA PRAKTEK</h2>
                </div>
                <ul class="nav nav-tabs">
            <li class="active"><a href="reportKPHarian.php">Laporan Harian</a></li>
            <li><a href="reportKPBulanan.php">Laporan Bulanan</a></li>
            <li><a href="reportKPTahunan.php">Laporan Tahunan</a></li>
        </ul>
            <div class="bs-example4" data-example-id="simple-responsive-table">
    <div class="table-responsive">
        <div class="col-md-6">
                <a href="cetakKPH.php"><button type="button" name="tambah" class="btn-primary btn" style="margin-left: -5%"> Cetak</button></a>
            </div>
            <br><br>
           <table class="table">
              <thead>
        ...
        $result  = mysqli_query($con,"SELECT * FROM log JOIN user ON log.id_user=user.id JOIN koleksikp ON log.id_koleksi=koleksikp.id_koleksiKP");
        $total   = mysqli_num_rows($result);
        $pages   = ceil($total/$halaman);
        $query   = mysqli_query($con,"SELECT * FROM log JOIN user ON log.id_user=user.id JOIN koleksikp ON koleksikp.id_koleksiKP=log.id_koleksi ORDER BY waktu DESC LIMIT $mulai, $halaman");
        $no      = $mulai+0;
