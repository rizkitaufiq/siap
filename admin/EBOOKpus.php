...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div class="graphs">
     	<div class="col_3">
     		<h1 style="margin-left: 37%">ARSIP E-BOOK</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="search pull-right">
                    <form action="EBOOKpus.php" method="GET">
        ...
        $page = isset($_GET['page']) ? intval($_GET['page']) : 1; 
                $adjacents = isset($_GET['adjacents']) ? intval($_GET['adjacents']) : 3; 
                    ...
                    if(isset($_REQUEST['cari']) && $_REQUEST['cari']<>""){
                        ...
                        $lihat = mysqli_query($con, "SELECT * FROM tmp_koleksiebook WHERE judul LIKE '%$cari%' OR penulis LIKE '%$cari%' OR jurusan LIKE '%$cari%' ORDER BY judul ASC"); 
                        $reload = $_SERVER['PHP_SELF'] . "?cari=".$cari."&amp;adjacents=".$adjacents; 
                    } else{
                        $lihat = mysqli_query($con, "SELECT * FROM tmp_koleksiebook ORDER BY judul ASC"); 
                ...
                echo "<td><button name='edit' data-id='".$hasil['id_tmpkoleksiebook']."' data-toggle='modal' data-target='#edit' class='btn-primary btn fa fa-pencil'></button></td>";
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                 ...
                 <h1 style="text-align: center;">Isi Arsip EBOOK</h1>
                </div>
            <div class="modal-body">
                <form method="post" id="insert_form" action="tambahebookPUS.php" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="lihat">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h3 style="text-align: center;" class="modal-title">Lihat Arsip EBOOK</h4>
                </div>
            <div class="modal-body">
    ...
    <div class="modal fade" id="edit">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h3 style="text-align: center;" class="modal-title">Edit Arsip EBOOK</h4>
                </div>
            <div class="modal-body">
                <div class="fetched-data"></div>
            </div>
