        ...
        <div class="row">
            <div class="col-md-12">
                <div class="search pull-right">
                    <form action="koleksikpPUS.php" method="GET">
      ...
      <table class="table">
        ...
        $page = isset($_GET['page']) ? intval($_GET['page']) : 1; 
            ...
            echo "<tr>";
                ...
                echo "<td><a href='tambah_kpPUS.php?id_tmpkoleksikp=".$hasil['id_tmpkoleksikp']."' class='btn-info btn fa fa-arrow-down'></button></td>";
