      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#ta">TUGAS AKHIR</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading">Tugas Akhir</h2>
            <hr class="my-4">
          </div>
        </div>
      </div>
         ...
         <div class="row">
            <div class="col-md-12">
                <div class="search pull-right">
                    <form action="Arsip_Ta.php" method="GET">
        ...
        $page = isset($_GET['page']) ? intval($_GET['page']) : 1; 
                $adjacents = isset($_GET['adjacents']) ? intval($_GET['adjacents']) : 3; 
                    ...
                    if(isset($_REQUEST['cari']) && $_REQUEST['cari']<>""){
                        ...
                        $lihat = mysqli_query($con, "SELECT * FROM koleksita WHERE judul LIKE '%$cari%' OR penulis LIKE '%$cari%' OR jurusan LIKE '%$cari%' OR dosbimTA LIKE '%$cari%' OR dosbimTA1 LIKE '%$cari%' ORDER BY judul ASC"); 
            ...
            echo "<tr>";
                ...
                echo "<td><a href='ta_pdf.php?id_koleksiTA=".$hasil['id_koleksiTA']."' class='fa fa-2x fa-book' ></a></td>"; 
            echo "</tr>";
            $i++;
            $count++;
            }
    ...
    <div class="modal fade" id="komen">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form method="post" id="insert_form" action="komen_saran1.php">
